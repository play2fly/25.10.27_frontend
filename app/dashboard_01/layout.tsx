...
const menuItems: MenuItem[] = [
  {
    ...
    disableLink: true,
    submenu: [
      { title: 'Main', href: '/dashboard_01/master/main' },
      { title: 'MEXC', href: '/dashboard_01/master/results' },
    ],
  },
  {
    title: 'User',
    ...
    disableLink: true,
    submenu: [
      { title: 'Main', href: '/dashboard_01/user/main' },
      { title: 'Results', href: '/dashboard_01/user/results' },
    ],
  },
  {
    title: 'Setting',
  ...
  },
  {
    ...
    disableLink: true,
    submenu: [
      { title: '뎁스', href: '/dashboard_01/menu3/sub1' },
      { title: '그리드', href: '/dashboard_01/menu3/sub1' },
      { title: '블링크', href: '/dashboard_01/menu3/sub1' },
    ],
  },
  {
    title: '거래설정',
    ...
    disableLink: true,
    submenu: [
      { title: '자전', href: '/dashboard_01/menu3/sub1' },
      { title: '스왑', href: '/dashboard_01/menu3/sub1' },
      { title: '벽뚫기', href: '/dashboard_01/menu3/sub1' },
      { title: '조건거래', href: '/dashboard_01/menu3/sub1' },
    ],
  },
  {
    title: '기타설정',
    ...
    <RequireApproval>
      <div style={{ display: 'flex', height: '100vh' }}>
        ...
        <nav style={{ width: '240px', backgroundColor: '#333', color: 'white', padding: '1rem' }}>
          <h2>
            <Link href="/dashboard_01" style={{ color: 'white', textDecoration: 'none' }}>
              DashBoard Home
            </Link>
          </h2>
